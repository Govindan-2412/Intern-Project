...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html"><span class="style2">A Comprehensive Study on Mining</span></a></h1>
      </div>
      <div class="menu">
        <ul>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1">An Efficient Multi-User Searchable Encryption Scheme without Query Transformation Over Outsourced Encrypted Data
</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
